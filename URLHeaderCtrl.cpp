// URLHeaderCtrl.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CURLHeaderCtrl, CHeaderCtrl)
	//{{AFX_MSG_MAP(CURLHeaderCtrl)
	ON_WM_SETCURSOR()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CURLHeaderCtrl message handlers

BOOL CURLHeaderCtrl::OnChildNotify(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pLResult) 
{
...
BOOL CURLHeaderCtrl::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message) 
{
...
void CURLHeaderCtrl::SetSortArrow( const int iSortColumn, const BOOL bSortAscending )
{
...
void CURLHeaderCtrl::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
...
void CURLHeaderCtrl::Serialize(CArchive& ar)
{
	if( ar.IsStoring() )
	{
